...
import androidhive.info.masinac.adapter.ContactAdapter;
import androidhive.info.masinac.model.RecyclerItemClickListener;
...
public class HomeFragment extends Fragment {
    ...
    private class GetTeme extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ContactAdapter adapter = new ContactAdapter(temeList);
                ...
                public void onItemClick(View view, int position) {
                    switch(position)
                    {
                        case 0: FragmentManager fragmentManager = getFragmentManager();
                            ...
                            fragmentTransaction.replace(R.id.container_body, new PredmetiOASFragment());
